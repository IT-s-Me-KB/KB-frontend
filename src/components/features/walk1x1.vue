<template>
  <div class="widget-container" @click="showDetails">
    <img :src="walkImage" alt="walk icon" class="walk-icon" />
  </div>
</template>

<script>
import walkImage from '/images/walk.png'; // Adjust the path according to your actual file location

export default {
  name: 'Widget',
  data() {
    return {
      walkImage, // Imported image
    };
  },
  methods: {
    showDetails() {
